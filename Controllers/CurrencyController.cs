...
namespace Api_Kaos_Net.Controllers
{
    ...
    public class CurrencyController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<CurrencyDto>> Create(CurrencyDto dto)
        {
            var created = await _service.CreateAsync(dto);
            return CreatedAtAction(nameof(GetById), new { id = created.CurrencyId }, created);
        }

        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, CurrencyDto dto)
        {
